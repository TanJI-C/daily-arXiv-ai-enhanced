...
### [1] [Метод ранжирования планов выполнения SQL-запросов на основе текстового описания и моделей векторных представлений](https://scholar.google.com/scholar_url?url=https://www.mais-journal.ru/jour/article/download/2096/1502&hl=zh-CN&sa=X&d=9707265570673839350&ei=D74_asqIDqPrieoP6L6iuAk&scisig=ANDmEU6ssXHLJQ1PxzPr1zxozYJC&oi=scholaralrt&hist=Pxo5FIAAAAAJ:5415062280803925783:ANDmEU7NvM9mECxuQvfhiYPQKyn_&html=&pos=0&folt=cit)
*НК Василенко*
...
### [2] [Query Cost Model Calibration in Confidential Virtual Machines](https://arxiv.org/abs/2606.26385)
...
### [3] [3D Spatial Pattern Matching](https://arxiv.org/abs/2606.26465)
...
### [4] [EcoTable: Cost-effective Table Integration in Data Lakes for Natural Language Queries](https://arxiv.org/abs/2606.26613)
...
### [5] [BtrLog: Low-Latency Logging for Cloud Database Systems](https://arxiv.org/abs/2606.27051)
...
### [6] [Understanding Domain-Aware Distribution Alignment in Budgeted Entity Matching](https://arxiv.org/abs/2606.27342)
