...
### [1] [NeurBench: A Benchmark Suite for Learned Database Components with Drift Modeling:[Experiments & Analysis]](https://scholar.google.com/scholar_url?url=https://dl.acm.org/doi/pdf/10.1145/3802091&hl=zh-CN&sa=X&d=4500669945998348516&ei=W_kQapqeK6eW6rQPxKq94Ac&scisig=AFyMTJWjk8EQxsKd3rdvlmb_KqBz&oi=scholaralrt&hist=Pxo5FIAAAAAJ:5415062280803925783:AFyMTJUIFm5lfAk6v9CO4y1JnB6O&html=&pos=2&folt=cit)
...
### [3] [Bridging the Gap: Cardinality Estimation for Semantic Queries on Unstructured Data](https://scholar.google.com/scholar_url?url=https://dl.acm.org/doi/pdf/10.1145/3802024&hl=en&sa=X&d=12562424259840982210&ei=W_kQarPrNu2O6rQP6M-TkAM&scisig=AFyMTJW2NUttaoY2DQbxo3uD76wE&oi=scholaralrt&hist=Pxo5FIAAAAAJ:6303853285888070373:AFyMTJXMQsrqYSvoB1EIom4eFGEv&html=&pos=0&folt=rel)
*S Xu,J Wang,G Li*
...
### [5] [The Impact of Dynamic Query Optimization Strategies on Performance and Resource Utilization in Cloud Databases](https://scholar.google.com/scholar_url?url=https://www.researchgate.net/profile/Dwayne-Mccoy/publication/404941021_The_Impact_of_Dynamic_Query_Optimization_Strategies_on_Performance_and_Resource_Utilization_in_Cloud_Databases/links/6a08e1d60fc2cb5022854879/The-Impact-of-Dynamic-Query-Optimization-Strategies-on-Performance-and-Resource-Utilization-in-Cloud-Databases.pdf&hl=zh-CN&sa=X&d=4299790294796254846&ei=62EQapCrN_i9ieoPk7SpqAQ&scisig=AFyMTJVGYcCVGrpFjnvX_9qZ4Wfm&oi=scholaralrt&hist=Pxo5FIAAAAAJ:10189913451943534390:AFyMTJUXzkSSSJ2ypqFZ-xAxAuOq&html=&pos=0&folt=kw-top)
*D McCoy*
...
Abstract: The increasing adoption of cloud computing technologies has significantly transformed database management systems and data processing architectures across modern enterprises. Cloud databases have emerged as critical infrastructures for supporting scalable, distributed, and highly available applications in domains such as finance, healthcare, e-commerce, artificial intelligence, and scientific computing. Despite the flexibility and scalability offered by cloud environments, efficient query processing remains a major challenge due to fluctuating workloads, distributed data storage, multi-tenant resource sharing, and dynamic infrastructure conditions. Traditional static query optimization methods are often insufficient in cloud environments because they rely on predefined execution plans that may become inefficient under changing workload patterns and system states. Consequently, dynamic query optimization strategies have become essential for improving database performance and resource utilization in cloud-based systems.
This study investigates the impact of dynamic query optimization strategies on performance and resource utilization in cloud databases. The research explores adaptive optimization techniques including runtime query re-optimization, cost-based optimization, adaptive indexing, workload-aware scheduling, machine learning-driven optimization, caching mechanisms, and distributed query execution frameworks. The study further examines how intelligent optimization systems dynamically adjust query execution plans according to workload conditions, infrastructure availability, and performance metrics within distributed cloud environments.

</details>


### [6] [A Study on Cloud-Native Database Optimization Techniques for Enhancing Scalability and Query Processing Efficiency](https://scholar.google.com/scholar_url?url=https://www.researchgate.net/profile/Benjamin-Owen-9/publication/404940842_A_Study_on_Cloud-Native_Database_Optimization_Techniques_for_Enhancing_Scalability_and_Query_Processing_Efficiency/links/6a08db45ffeb2910364b95ea/A-Study-on-Cloud-Native-Database-Optimization-Techniques-for-Enhancing-Scalability-and-Query-Processing-Efficiency.pdf&hl=zh-CN&sa=X&d=5113791843814072906&ei=62EQapCrN_i9ieoPk7SpqAQ&scisig=AFyMTJWMBLRJd9xnN4TnYBcc5m87&oi=scholaralrt&hist=Pxo5FIAAAAAJ:10189913451943534390:AFyMTJUXzkSSSJ2ypqFZ-xAxAuOq&html=&pos=2&folt=kw-top)
*B Owen*
...
Abstract: The rapid growth of cloud computing, big data analytics, and distributed applications has significantly transformed the architecture and operational requirements of modern database systems. Traditional monolithic database infrastructures are increasingly unable to satisfy the scalability, elasticity, and performance demands of contemporary cloud-based applications. Consequently, cloud-native databases have emerged as critical solutions for supporting dynamic workloads, distributed environments, and highvolume transactional systems. Cloud-native database architectures are specifically designed to leverage the advantages of cloud computing technologies such as containerization, microservices, distributed storage, and elastic resource provisioning. However, despite these advancements, challenges associated with query processing efficiency, workload balancing, latency reduction, and scalable resource management remain major concerns in cloud-native database environments.
This study investigates cloud-native database optimization techniques aimed at enhancing scalability and query processing efficiency in distributed computing infrastructures. The research explores advanced optimization mechanisms including distributed query execution, intelligent indexing strategies, workloadaware resource allocation, data partitioning, caching frameworks, auto-scaling architectures, and containerized orchestration systems. The study also examines how emerging technologies such as Kubernetes, serverless computing, artificial intelligence-driven optimization, and edge-cloud integration contribute to improved database performance and operational resilience.

</details>


### [7] [B. Mitschang et al.(Hrsg.): Datenbanksysteme für Business, Technologie und Web (BTW 2017), Lecture Notes in Informatics (LNI), Gesellschaft für Informatik, Bonn …](https://scholar.google.com/scholar_url?url=https://dl.gi.de/server/api/core/bitstreams/2d743072-bb28-4465-ac1a-b1d9cbabba39/content&hl=zh-CN&sa=X&d=16205152880682127472&ei=62EQapCrN_i9ieoPk7SpqAQ&scisig=AFyMTJVBbnEguYbbf8wUq9Hp0Shq&oi=scholaralrt&hist=Pxo5FIAAAAAJ:10189913451943534390:AFyMTJUXzkSSSJ2ypqFZ-xAxAuOq&html=&pos=4&folt=kw-top)
*V Leis*
...
Abstract: … and query optimization. In particular, we present a concurrent transaction processing system based on … Finally, we dissect the query optimization process … Finally, even the venerable field of query optimization still has many unsolved problems. …

</details>


### [8] [AI-orchestrated SQL optimization engines for high-volume financial reconciliation workflows](https://scholar.google.com/scholar_url?url=https://www.tandfonline.com/doi/abs/10.1080/20421338.2026.2659624&hl=zh-CN&sa=X&d=7561752830511148049&ei=62EQapCrN_i9ieoPk7SpqAQ&scisig=AFyMTJVIVFvVamn7UtMCwDOhSMdg&oi=scholaralrt&hist=Pxo5FIAAAAAJ:10189913451943534390:AFyMTJUXzkSSSJ2ypqFZ-xAxAuOq&html=&pos=5&folt=kw-top)
*SR Keshireddy,NH Jamithireddy,NS Jamithireddy…*
...
### [9] [Beyond Maximum Common Subgraph: A Framework Maximizing Shared Computation for Multi-Query Subgraph Matching](https://scholar.google.com/scholar_url?url=https://dl.acm.org/doi/pdf/10.1145/3802022&hl=zh-CN&sa=X&d=15777865427543233954&ei=62EQapCrN_i9ieoPk7SpqAQ&scisig=AFyMTJULul9X7ri31b8EzymUOeV6&oi=scholaralrt&hist=Pxo5FIAAAAAJ:10189913451943534390:AFyMTJUXzkSSSJ2ypqFZ-xAxAuOq&html=&pos=6&folt=kw-top)
*Z Zhang,S Yang,W Zheng,Q Zhou,C Hong*
...
### [10] [PIPER: Content-Based Table Search via profiling and LLM-Generated Pseudoqueries](https://scholar.google.com/scholar_url?url=https://arxiv.org/pdf/2605.18199&hl=zh-CN&sa=X&d=2131313508526028065&ei=62EQapCrN_i9ieoPk7SpqAQ&scisig=AFyMTJUI3Zj4rmjuYZ5BI-nXcbBj&oi=scholaralrt&hist=Pxo5FIAAAAAJ:10189913451943534390:AFyMTJUXzkSSSJ2ypqFZ-xAxAuOq&html=&pos=7&folt=kw-top)
*R Terrenzi,M Falconi,S Ayvaz,P Plebani*
...
### [11] [VecBench: A Controllable Benchmark for Filtered Vector Search:[Experiments & Analysis]](https://scholar.google.com/scholar_url?url=https://dl.acm.org/doi/pdf/10.1145/3802125&hl=zh-CN&sa=X&d=13726282050163908628&ei=62EQapCrN_i9ieoPk7SpqAQ&scisig=AFyMTJWefmJQBwHjdsU1XHFOUFcT&oi=scholaralrt&hist=Pxo5FIAAAAAJ:10189913451943534390:AFyMTJUXzkSSSJ2ypqFZ-xAxAuOq&html=&pos=9&folt=kw-top)
*X Zhang,C Zhang,J Fan,G Li,X Du*
...
### [13] [On Self-Designing Learned Indexes](https://scholar.google.com/scholar_url?url=https://dl.acm.org/doi/pdf/10.1145/3802096&hl=zh-CN&sa=X&d=212205706955542451&ei=7GEQarfhAfOjieoP56SSuA8&scisig=AFyMTJXblS06YvMCEuLB0XjpBAtT&oi=scholaralrt&hist=Pxo5FIAAAAAJ:15658717702251462117:AFyMTJUa7vWVISNypFCoztO6uuis&html=&pos=1&folt=kw-top)
*B Han,G Hu,B Li,X Xiao,Z Zhao,BC Ooi*
...
Abstract: … To enable cost-aware selection, we provide a cost model to estimate the benefit and overhead of SELIX based on index structural properties. In particular, for a workload with read ratio 𝑟 and write ratio 𝑤, the total cost is 𝑇𝑡𝑜𝑡𝑎𝑙 = 𝑟 ·𝑇𝑙𝑜𝑜𝑘𝑢𝑝 …

</details>


### [14] [LICO: An SIMD-Aware High-Performance Learned Inverted Index Compression Framework](https://scholar.google.com/scholar_url?url=https://dl.acm.org/doi/pdf/10.1145/3802079&hl=zh-CN&sa=X&d=4307015454750982096&ei=7GEQarfhAfOjieoP56SSuA8&scisig=AFyMTJVMWwvF2kaa4IvyA-Lb1UgJ&oi=scholaralrt&hist=Pxo5FIAAAAAJ:15658717702251462117:AFyMTJUa7vWVISNypFCoztO6uuis&html=&pos=2&folt=kw-top)
*X Zhu,Q Liu,G Zhang,Z Sha,J Liao,S Hu,L Chen*
...
### [16] [EncoderForge: Generating Efficient SQL for Encoders in Machine Learning Inference Pipelines](https://scholar.google.com/scholar_url?url=https://dl.acm.org/doi/pdf/10.1145/3802050&hl=zh-CN&sa=X&d=16751384393154620613&ei=7GEQarfhAfOjieoP56SSuA8&scisig=AFyMTJWzttrHSf7kc_6r8ymgL8hY&oi=scholaralrt&hist=Pxo5FIAAAAAJ:15658717702251462117:AFyMTJUa7vWVISNypFCoztO6uuis&html=&pos=4&folt=kw-top)
...
### [17] [Optimized ship routing algorithm](https://scholar.google.com/scholar_url?url=https://pubs.aip.org/aip/acp/article-abstract/3441/1/060008/3391571&hl=zh-CN&sa=X&d=2367652315085867589&ei=7GEQarfhAfOjieoP56SSuA8&scisig=AFyMTJUh7djbLnaxQBpeELY3RwBY&oi=scholaralrt&hist=Pxo5FIAAAAAJ:15658717702251462117:AFyMTJUa7vWVISNypFCoztO6uuis&html=&pos=5&folt=kw-top)
*V Sharma,Y Parmar,A Patel,SK Mathariya,J Surana…*
...
Abstract: … The reduced cost model and static usage of the data indicate the necessity for the deep learning cost forecasting model and incorporation of dynamic weather. Lastly, the single-objective optimization highlights the necessity for multiobjective optimization. …

</details>


### [18] [A Multi-Layer Cloud-IDS Pipeline with LLM and Adaptive Q-Learning Calibration](https://scholar.google.com/scholar_url?url=https://arxiv.org/pdf/2605.15889&hl=zh-CN&sa=X&d=7967790535428187516&ei=7GEQarfhAfOjieoP56SSuA8&scisig=AFyMTJVpfyhC8QmmzAvdh4OuSYKO&oi=scholaralrt&hist=Pxo5FIAAAAAJ:15658717702251462117:AFyMTJUa7vWVISNypFCoztO6uuis&html=&pos=6&folt=kw-top)
*SW Ali,IA Shah,F Zahid,D Munir,HD Schotten*
...
### [19] [Are Learned DBMS Components Robust to Workload Drift?:[Experiments & Analysis]](https://scholar.google.com/scholar_url?url=https://dl.acm.org/doi/pdf/10.1145/3802014&hl=zh-CN&sa=X&d=16583240559794514850&ei=7GEQarfhAfOjieoP56SSuA8&scisig=AFyMTJWjBUppsWUxs_iorQKxwC45&oi=scholaralrt&hist=Pxo5FIAAAAAJ:15658717702251462117:AFyMTJUa7vWVISNypFCoztO6uuis&html=&pos=7&folt=kw-top)
*Z Meng,G Cong,S Luo*
...
### [20] [OBELISK: Efficient Offline Query Planning with Bayesian Optimization-Informed Language Model Reasoning](https://scholar.google.com/scholar_url?url=https://www.vldb.org/pvldb/vol19/p1674-pan.pdf&hl=zh-CN&sa=X&d=9564828572918741327&ei=7GEQarfhAfOjieoP56SSuA8&scisig=AFyMTJUk5m4wu9yfJUdw9pEuui-4&oi=scholaralrt&hist=Pxo5FIAAAAAJ:15658717702251462117:AFyMTJUa7vWVISNypFCoztO6uuis&html=&pos=8&folt=kw-top)
...
### [21] [PDO-SFCM: Prediction-Driven Orchestration for SFC Migration in SAGIN via Fine-Tuned Large Time-Series Model and DRL](https://scholar.google.com/scholar_url?url=https://ieeexplore.ieee.org/abstract/document/11523103/&hl=zh-CN&sa=X&d=2198963887990507844&ei=7GEQarfhAfOjieoP56SSuA8&scisig=AFyMTJVb48fj-9SIWAoAW9I4AUMj&oi=scholaralrt&hist=Pxo5FIAAAAAJ:15658717702251462117:AFyMTJUa7vWVISNypFCoztO6uuis&html=&pos=9&folt=kw-top)
*J Mo,K Zhao,L Peng,HC Wu*
