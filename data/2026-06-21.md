...
### [6] [DQSim: Does the Task Assignment Slow Down Your Distributed Database System?](https://scholar.google.com/scholar_url?url=https://db.in.tum.de/~rieger/papers/dqsim.pdf&hl=zh-CN&sa=X&d=5109459058651910610&ei=QtY1ar2mCbi96rQPtbmAkAU&scisig=ANDmEU4yMApY5NVX-KoajdYYiKic&oi=scholaralrt&hist=Pxo5FIAAAAAJ:5415062280803925783:ANDmEU7NvM9mECxuQvfhiYPQKyn_&html=&pos=1&folt=cit)
*M Rieger,T Neumann*
...
### [7] [SELVA: A Reliable and Fast Selectivity Estimation Method for Query Plan Optimization in Video Analytics](https://scholar.google.com/scholar_url?url=https://link.springer.com/chapter/10.1007/978-981-95-4149-2_11&hl=zh-CN&sa=X&d=12000259524083862366&ei=QtY1ar2mCbi96rQPtbmAkAU&scisig=ANDmEU6Ci72O0cmQFQJLhL3QCYEv&oi=scholaralrt&hist=Pxo5FIAAAAAJ:5415062280803925783:ANDmEU7NvM9mECxuQvfhiYPQKyn_&html=&pos=5&folt=cit)
...
### [8] [REMOP: REmote-Memory-aware OPerator Optimization](https://arxiv.org/abs/2606.19576)
...
### [9] [DeQL: A Decision Query Language for Prescriptive Analytics over Relational Data](https://arxiv.org/abs/2606.19751)
...
### [14] [Caching for Dollars, Not Hits: An Exact Offline Reference for Cloud-Egress Caching and the Crossover That Decides When It Pays](https://arxiv.org/abs/2606.20539)
...
### [15] [Cumulative Damage Simulation and Self-learning Response Surface-Based Non-intrusive Online Monitoring of Random Wear Degradation for Shaft Products](https://scholar.google.com/scholar_url?url=https://ieeexplore.ieee.org/abstract/document/11563907/&hl=zh-CN&sa=X&d=17021940174160505676&ei=ATU2av6BMLq1ieoPjc_k2Ao&scisig=ANDmEU6-souC9vUzFXbW3KpQTGzJ&oi=scholaralrt&hist=Pxo5FIAAAAAJ:15658717702251462117:ANDmEU4utGFoJ5R0YybN4hQIkf9F&html=&pos=0&folt=kw-top)
*B Sun,L Zhou,Z Wu,Y Zhou,Q Feng,J Pan,T Lin…*
...
Abstract: The paper introduces a combined design of experiments, response surface methodology, and machine learning framework for the optimization of low-cost ceramic water filters manufactured from locally sourced clays. Three types of clays (black cotton, red, and alluvial) combined with sawdust (40–70 wt%) were evaluated over a firing temperature range of 850–950 C. Multiresponse optimization identified the final optimal conditions at 66 wt% sawdust and a firing temperature of 950 C, yielding an overall desirability index of 0.92. At this point, microbial removal exceeded 95%, and effective porosity was approximately 45%. Scanning electron microscopy confirmed that these performance peaks correlate with the formation of interconnected macropore networks (∼ 10–150 μm) and microcracks. While higher firing temperatures encouraged densification, the random forest model demonstrated superior predictive accuracy (R2= 0.97) in capturing the nonlinear relationship between fabrication parameters and microbial rejection. This hybrid approach provides a scalable pathway for decentralized water treatment in line with UN Sustainable Development Goals 6 and 12.

</details>


### [18] [Surplus-Driven Reinforcement Learning for Service Placement in Mobile Edge Computing](https://scholar.google.com/scholar_url?url=https://ieeexplore.ieee.org/abstract/document/11555329/&hl=zh-CN&sa=X&d=12726900883419147837&ei=ATU2av6BMLq1ieoPjc_k2Ao&scisig=ANDmEU6hQhlht-z67T4wwNUtCe2Q&oi=scholaralrt&hist=Pxo5FIAAAAAJ:15658717702251462117:ANDmEU4utGFoJ5R0YybN4hQIkf9F&html=&pos=3&folt=kw-top)
*P Tripathi,S Kumar*
...
Abstract: In a Mobile Edge Computing (MEC) setup, Service Providers (SPs) often do not own the edge infrastructure, since it is managed by independent Infrastructure Providers (IPs). This separation requires economic negotiation for service placement under resource and cost constraints, involving dynamic coordination between the SP and the IP with asymmetric information and differing goals. Centralized or static models fail to capture strategic behavior and private preferences, making negotiationbased approaches essential. We model MEC placement as a finite-horizon bargaining game and implement a Proximal Policy Optimization (PPO) framework. The SP learns dynamic pricing under partial observability, whereas IPs follow various concession strategies. To encourage fair and efficient agreements, we apply reward shaping based on a Nash-log-based surplus with time decay, along with a demand-aware feasibility filter that excludes economically infeasible negotiations. Experiments on real MEC traces show that our method increases the SP surplus by 29.2 %, increases the agreement rate by 9.8 % and lowers the negotiated prices by 35 %, while converging in fewer rounds. These results show that our reinforcement learning (RL) based bargaining approach provides a scalable and adaptive solution for decentralized MEC placement under behavioral and economic uncertainty.

</details>


### [19] [Complexity-Aware Training Time Prediction in Cybersecurity](https://scholar.google.com/scholar_url?url=https://assets.zyrosite.com/Y4LPPPQnD3hkEzxv/boa_nasca26_merged-11PYWCPejm0d9RYB.pdf%23page%3D39&hl=zh-CN&sa=X&d=13206009740978853269&ei=ATU2av6BMLq1ieoPjc_k2Ao&scisig=ANDmEU7aw_mu0I2HnZWf9nitPP6b&oi=scholaralrt&hist=Pxo5FIAAAAAJ:15658717702251462117:ANDmEU4utGFoJ5R0YybN4hQIkf9F&html=&pos=4&folt=kw-top)
*M Boubekraoui,S Haidrar*
...
Abstract: Abstract Machine learning systems are increasingly deployed in operational environments where computational efficiency plays a central role. Beyond predictive accuracy, training time has become a decisive factor in experiment planning, model updating, and infrastructure management. In cybersecurity applications, where detection models must be frequently retrained to adapt to evolving threats, reliable runtime estimation is particularly important. Classical asymptotic complexity analysis provides theoretical growth behavior but …

</details>


### [20] [End-to-end robust system discovery in electrical dynamical systems using scientific machine learning](https://scholar.google.com/scholar_url?url=https://www.nature.com/articles/s44172-026-00689-2_reference.pdf&hl=zh-CN&sa=X&d=14156677944479284641&ei=ATU2av6BMLq1ieoPjc_k2Ao&scisig=ANDmEU5v7ljJmMphkGXtW-CagVjB&oi=scholaralrt&hist=Pxo5FIAAAAAJ:15658717702251462117:ANDmEU4utGFoJ5R0YybN4hQIkf9F&html=&pos=5&folt=kw-top)
*J Chakravorty,N Ripamonti,T Laneryd*
...
Abstract: Distributed quantum computing provides scalability while offering advantages such as enhanced noise mitigation and higher fidelity. Leveraging this, distributed quantum machine learning (DQML) can provide better solutions to practical machine learning (ML) tasks, in contrast to classical ML and single-device QML performance. A key objective in DQML is to reduce inter-node communication costs, thereby enhancing efficiency, accuracy, and mitigating communication-induced noise. Existing communication-optimization approaches are generally application-agnostic and do not address the specific demands of QML circuits-especially quantum neural networks (QNNs), which require iterative training, large input sizes, and gradientbased updates. We propose DCoRE-QML, a framework designed for distributed QML that minimizes communication overhead while accounting for network dynamics (link and node failures) to improve robustness. It employs localized data encoding, delayed weight updates, compression techniques, and persistent entanglement purification to improve performance and fidelity. Experimental results indicate that it outperforms generic state-of-the-art solutions for QNN circuits, with higher fidelity.

</details>


### [22] [What Matters: Datasets or Robust Frameworks in Modern Robot Learning?](https://scholar.google.com/scholar_url?url=https://www.preprints.org/frontend/manuscript/3ee3d162809a7afeecdf18301ded8c7f/download_pub&hl=zh-CN&sa=X&d=6459273478863827455&ei=ATU2av6BMLq1ieoPjc_k2Ao&scisig=ANDmEU67LwRWoKzqT4BF8YdTEzGi&oi=scholaralrt&hist=Pxo5FIAAAAAJ:15658717702251462117:ANDmEU4utGFoJ5R0YybN4hQIkf9F&html=&pos=7&folt=kw-top)
*MS Sarowar*
...
### [23] [AI-Driven Real-Time Benefits Administration with Intelligent Agents](https://scholar.google.com/scholar_url?url=https://jaaionline.org/archives/volume2/number6/chattopadhyay-jaai-ca20d9244614.pdf&hl=zh-CN&sa=X&d=8834209828616110733&ei=ATU2av6BMLq1ieoPjc_k2Ao&scisig=ANDmEU4pIq3S6xHuJToLUe-I3jsc&oi=scholaralrt&hist=Pxo5FIAAAAAJ:15658717702251462117:ANDmEU4utGFoJ5R0YybN4hQIkf9F&html=&pos=8&folt=kw-top)
*S Chattopadhyay*
...
Abstract: … (MCS) integrated with machine learning for intelligent eligibility determination, document … strategies for small-employer deployments, transfer learning for new-hire fraud detection, and … The cost model assumes a standard enrollment event profile; …

</details>


### [24] [RouteBalance: Fused Model Routing and Load Balancing for Heterogeneous LLM Serving](https://scholar.google.com/scholar_url?url=https://arxiv.org/pdf/2606.17949&hl=zh-CN&sa=X&d=11413774839251197611&ei=ATU2av6BMLq1ieoPjc_k2Ao&scisig=ANDmEU5NvDwqZ85iuzwKLvZAPAKD&oi=scholaralrt&hist=Pxo5FIAAAAAJ:15658717702251462117:ANDmEU4utGFoJ5R0YybN4hQIkf9F&html=&pos=9&folt=kw-top)
*W Da,E Kalyvianaki*
...
Abstract: … The learned predictor is therefore not load-bearing for the headline frontier: what the baselines lack is a latency term in model selection at all. We retain the learned … Cost-model sensitivity (five price vectors) leaves all orderings invariant. Why latency …
...
### [25] [A Survey of LLM-Powered Question Answering Through the Lens of Query Processing](https://scholar.google.com/scholar_url?url=https://www.preprints.org/frontend/manuscript/d10a2b4a2daa4a5d271da1c5c7e1ce59/download_pub&hl=zh-CN&sa=X&d=11741463268937519986&ei=ATU2arGoK4yXieoPp8rUuQY&scisig=ANDmEU5XTUhNmCrZJgE5dhezQRfD&oi=scholaralrt&hist=Pxo5FIAAAAAJ:10189913451943534390:ANDmEU6kz551aLzfiFTYjYcpFycR&html=&pos=0&folt=kw-top)
*G Hua,T Wang,Z Bao,S Sadiq,Q Xie*
...
### [26] [MGI: A Communication Framework for Data Processing in Massive GPU Infrastructures](https://scholar.google.com/scholar_url?url=https://ddiwu.com/assets/pdf/magi_final.pdf&hl=zh-CN&sa=X&d=6608727557278049322&ei=ATU2arGoK4yXieoPp8rUuQY&scisig=ANDmEU5hoe_7KG3RhNtHqL261NYV&oi=scholaralrt&hist=Pxo5FIAAAAAJ:10189913451943534390:ANDmEU6kz551aLzfiFTYjYcpFycR&html=&pos=1&folt=kw-top)
*D Wu,H Tan,H Yang,B He,Q Zhang*
...
Abstract: This paper presents MGI, a general communication framework for performing data processing tasks in massive GPU infrastructures. Inter-GPU data transfer performance is crucial to multi-GPU data processing, and existing solutions repeatedly implement the same set of communication optimizations. MGI identifies these techniques and applies them judiciously behind a simple interface. Enabling MGI are (1) a central controller that models relevant hardware resources as an annotated graph and automates infrastructurelevel optimizations to construct transfer plans and (2) a scalable data plane where buffers and executors are carefully designed to incorporate device-and link-level optimizations to execute data transfers efficiently. Our experiments on a variety of GPU infrastructures and workloads show that MGI significantly improves multi-GPU data processing performance compared to existing frameworks.
...
### [28] [Improved Join Order Optimization for Database Queries using Hybrid Quantum-Classical Approaches for QUBO Problems](https://scholar.google.com/scholar_url?url=https://arxiv.org/pdf/2606.16247&hl=en&sa=X&d=7224665734586142288&ei=QtY1atbpGPqy6rQP4M3DWA&scisig=ANDmEU7LoFtjHNKK0faPx4v6wOw-&oi=scholaralrt&hist=Pxo5FIAAAAAJ:6303853285888070373:ANDmEU4ZlFrf9kHCF7HHEm7vYY6A&html=&pos=1&folt=rel)
...
### [29] [When Does q-error Predict Plan Regret? Three Regimes of Cardinality-Estimation Error](https://scholar.google.com/scholar_url?url=https://arxiv.org/pdf/2606.15600&hl=en&sa=X&d=8676539330461633753&ei=QtY1atbpGPqy6rQP4M3DWA&scisig=ANDmEU6APurEy9QhFpp45FHeScvL&oi=scholaralrt&hist=Pxo5FIAAAAAJ:6303853285888070373:ANDmEU4ZlFrf9kHCF7HHEm7vYY6A&html=&pos=2&folt=rel)
*M Mandarapu,S Kunkunuru*
...
### [30] [OmniQO: An Adaptive Framework for Integrating ML and Traditional Query Optimizers](https://scholar.google.com/scholar_url?url=https://link.springer.com/chapter/10.1007/978-981-95-4149-2_4&hl=en&sa=X&d=7864597647984130057&ei=QtY1atbpGPqy6rQP4M3DWA&scisig=ANDmEU5-t0ODE7bspVnQKrmZBmGX&oi=scholaralrt&hist=Pxo5FIAAAAAJ:6303853285888070373:ANDmEU4ZlFrf9kHCF7HHEm7vYY6A&html=&pos=3&folt=rel)
...
### [32] [VF-FD: Feature Deduplication for Vertical Federated Learning](https://scholar.google.com/scholar_url?url=https://link.springer.com/chapter/10.1007/978-981-95-4149-2_17&hl=en&sa=X&d=8023207891505022637&ei=QtY1asjQKPqy6rQP4M3DWA&scisig=ANDmEU5h6a-kpQnVFmsvcbto8doH&oi=scholaralrt&hist=Pxo5FIAAAAAJ:8045833917096571912:ANDmEU4Tb3SsXdLzPqQVdIwXgZgP&html=&pos=1&folt=cit)
